...
public class GET_All_ClassPackages {
    public String endpointGETvalid = "http://18.141.56.154:8000/admin/classes/packages";
    public String endpointGET_Invalid = "http://18.141.56.154:8000/admin/classes/packag";


    @Step("admin set_valid GET all ClassPackages endpoint")
    public String setEnpointGetvalid() {
        return endpointGETvalid;
    }

    @Step("admin set invalid GET all ClassPackages endpoint")
    public String setEnpointGetInvalid() {
        return endpointGET_Invalid;
    }

    @Step("admin send GET HTTP request with valid endpoint for all ClassPackages")
    ...
    @Step("admin received valid GET HTTP response code 200 for all ClassPackages")
